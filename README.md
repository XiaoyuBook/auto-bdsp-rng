...
当前正式版为 [v3.0.3](https://github.com/XiaoyuBook/auto-bdsp-rng/releases/tag/v3.0.3)。普通用户请不要下载 GitHub 绿色 `Code` 按钮中的源码压缩包，请下载 Windows x64 绿色版：

```text
auto-bdsp-rng-v3.0.3-windows-x64.zip
```
...
`v3.0.0` 是首个内置升级器的正式版。已安装 `v3.0.0`、`v3.0.1` 或 `v3.0.2` 的用户可以直接在软件中检查并升级到 `v3.0.3`，无需重新下载完整压缩包；`v2.1.7` 及更早版本仍需要完整下载一次上述 zip。
