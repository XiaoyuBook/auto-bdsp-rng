...
<p align="center"><sub>v3.2.0 源码的实际界面，展示未连接设备时的初始状态；新版安装包正在准备发布。</sub></p>
...
当前正式版为 **[v3.1.1](https://github.com/XiaoyuBook/auto-bdsp-rng/releases/tag/v3.1.1)**。

1. 在 Release 页的 **Assets** 中下载 `auto-bdsp-rng-v3.1.1-windows-x64.zip`。
...
> **v3.2.0 新增：首次乱数引导（待发布）**
>
> 当前源码已加入首次身份选择、控件高亮、框选与录制演示、OCR 核对及首次单次运行教学。首次启动选择「我是小白」，或点击顶部「开始引导」即可进入；进度可保存并继续。此功能将随 v3.2.0 发布。[了解引导流程 →](docs/USAGE.md#首次乱数引导)
