...
<p align="center"><sub>当前 main 源码的实际界面，展示未连接设备时的初始状态；「开始引导」尚未包含在 v3.1.1 正式包中。</sub></p>
...
> **main 新增：首次乱数引导**
>
> 当前源码已加入首次身份选择、控件高亮、框选与录制演示、OCR 核对及首次单次运行教学。首次启动选择「我是小白」，或点击顶部「开始引导」即可进入；进度可保存并继续。此功能尚未包含在 v3.1.1 正式包中。[了解引导流程 →](docs/USAGE.md#首次乱数引导)
