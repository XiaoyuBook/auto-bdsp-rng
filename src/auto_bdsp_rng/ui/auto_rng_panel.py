...
class AutoRngPanel(AutomationLifecycle, QWidget):
    ...
    def _build_strategy_group(self) -> QGroupBox:
        ...
        self.reverse_lookup_window.setFixedWidth(strategy_detail_width)
