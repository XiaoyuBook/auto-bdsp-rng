...
class KeyMappingDialog(QDialog):
    ...
    # 原版 FormKeyMapping 坐标 (999×830 拉伸空间) → 786×786 图片空间
    # scale_x = 786/999 ≈ 0.7868, scale_y = 786/830 ≈ 0.9470
    _BTN_POSITIONS: list[tuple[int, int, int, int, str, str]] = [
        # 左肩 ZL / L
        (220, 127, 48, 36, "ZL", "ZL"), (220, 174, 48, 36, "L", "L"),
        # 右肩 ZR / R
        (506, 127, 48, 36, "ZR", "ZR"), (506, 174, 48, 36, "R", "R"),
        # 功能区 Minus / Capture / Home / Plus
        (287, 226, 42, 32, "Minus", "－"), (328, 275, 48, 32, "Capture", "□"),
        (411, 275, 48, 32, "Home", "◎"), (449, 226, 42, 32, "Plus", "＋"),
        # 左摇杆方向
        (172, 226, 46, 46, "LSUp", "LS↑"), (172, 322, 46, 46, "LSDown", "LS↓"),
        (115, 274, 46, 46, "LSLeft", "LS←"), (229, 274, 46, 46, "LSRight", "LS→"),
        # 左摇杆按下
        (172, 274, 46, 46, "LClick", "🔘"),
        # 十字键 4 向 + 4 对角
        (277, 339, 38, 36, "Up", "↑"), (277, 416, 38, 36, "Down", "↓"),
        (238, 374, 38, 36, "Left", "←"), (316, 374, 38, 36, "Right", "→"),
        (238, 339, 38, 36, "UpLeft", "↖"), (316, 339, 38, 36, "UpRight", "↗"),
        (238, 416, 38, 36, "DownLeft", "↙"), (316, 416, 38, 36, "DownRight", "↘"),
        # 右摇杆方向
        (449, 338, 46, 46, "RSUp", "RS↑"), (449, 435, 46, 46, "RSDown", "RS↓"),
        (393, 386, 46, 46, "RSLeft", "RS←"), (505, 386, 46, 46, "RSRight", "RS→"),
        # 右摇杆按下
        (449, 386, 46, 46, "RClick", "🔘"),
        # ABXY
        (544, 236, 40, 40, "X", "X"), (498, 276, 40, 40, "Y", "Y"),
        (596, 276, 40, 40, "A", "A"), (544, 322, 40, 40, "B", "B"),
    ]
